...
;------------------------- Programa pricipal ------------------------------------------------------------------------------------------			
					...
					call			dibujo									;Carga todos los datos de las letras.

clc				
					call			muestra								;Muestra el mensaje en pantalla.
...
;-----------------------------------------------------------------------------------------------------------------------------------------------------
;	Muestra el dibujo en pantalla: Esta subrutina matiene rotando un bit en el puerto E haciendo un barrido de los datos.
